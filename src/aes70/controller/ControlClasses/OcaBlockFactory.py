...
OcaBlockFactory = make_control_class(
    ...
    [
      ['ProtoPorts', [OcaList(OcaProtoPort)], 3, 1, False, False, None],
      ['ProtoMembers', [OcaList(OcaProtoObjectIdentification)], 3, 2, False, False, None],
      ['ProtoSignalPaths', [OcaMap(OcaUint16, OcaProtoSignalPath)], 3, 3, False, False, None],
      ['GlobalType', [OcaGlobalTypeIdentifier], 3, 4, False, False, None],
    ],
    []
)
