from ....aes70.OCP1.OcaPositionCoordinateSystem import OcaPositionCoordinateSystem
from ....aes70.OCP1.OcaPositionDescriptor import OcaPositionDescriptor
from ....aes70.OCP1.OcaPositionDescriptorFieldFlags import OcaPositionDescriptorFieldFlags
...
OcaPhysicalPosition = make_control_class(
  ...
  [
    ...
    ['PositionDescriptorFieldFlags', [OcaPositionDescriptorFieldFlags], 3, 2, true, false, null
    ],
