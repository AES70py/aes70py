...
from ....aes70.OCP1.OcaMediaClockAvailability import OcaMediaClockAvailability
from ....aes70.OCP1.OcaMediaClockRate import OcaMediaClockRate
...
OcaMediaClock3 = make_control_class(
  ...
  [
    ...
    ['SupportedRates', [OcaMap(OcaUint32, OcaList(OcaMediaClockRate))], 3, 5, false, false, null
    ],
  ],
  []
);
