from ....aes70.OCP1.OcaGlobalTypeIdentifier import OcaGlobalTypeIdentifier
from ....aes70.OCP1.OcaList import OcaList
from ....aes70.OCP1.OcaMap import OcaMap
from ....aes70.OCP1.OcaPortMode import OcaPortMode
from ....aes70.OCP1.OcaProtoObjectIdentification import OcaProtoObjectIdentification
from ....aes70.OCP1.OcaProtoPort import OcaProtoPort
from ....aes70.OCP1.OcaProtoPortID import OcaProtoPortID
from ....aes70.OCP1.OcaProtoSignalPath import OcaProtoSignalPath
...
# **OcaPorts** that are allocated to new blocks the factory builds. As well, the
# proto-objects in the factory may contain lists of their own proto-ports.
# Together, the factory's proto-ports and its members' proto-ports are used to
# define the factory's set of proto-signal paths. Factories may be predefined at
# time of device manufacture, or constructed "on the fly" by controllers. To
...
OcaBlockFactory = make_control_class(
  'OcaBlockFactory',
  3,
  '\u0001\u0001\u0004',
  2,
  ...
  [
    ...
    ['ProtoMembers', [OcaList(OcaProtoObjectIdentification)], 3, 2, false, false, null
    ],
    ['ProtoSignalPaths', [OcaMap(OcaUint16, OcaProtoSignalPath)], 3, 3, false, false, null
    ],
...
# Gets the factory's list of proto-ports. The return value indicates whether the
# list was successfully retrieved.
#
# @method OcaBlockFactory#GetProtoPorts
# @returns {Promise<list[OcaProtoPort]>}
#   A promise which resolves to a single value of type ``list[OcaProtoPort]``.
...
# @param {int} ProtoObjectNumber
#
# @returns {Promise<None>}
# Gets the factory's list of proto-members. Does not recurse inner proto-blocks.
# The return value indicates whether the list was successfully retrieved.
#
# @method OcaBlockFactory#GetProtoMembers
# @returns {Promise<list[OcaProtoObjectIdentification]>}
#   A promise which resolves to a single value of type ``list[OcaProtoObjectIdentification]``.
# Defines a proto-signal path in the factory. The return value indicates whether
# the proto-signal path was successfully defined.
#
...
# @returns {Promise<Dict[int, OcaProtoSignalPath]>}
#   A promise which resolves to a single value of type ``Dict[int, OcaProtoSignalPath]``.
# Gets the global type identifier for blocks created by this factory. The return
# value indicates whether the identifier was successfully retrieved. **Added in
...
# Sets the global type identifier for blocks created by this factory. The return
# value indicates whether the identifier was successfully set. **Added in
# version 2 of this class.**
#
...
#
# @member {PropertyEvent<list[OcaProtoPort]>} OcaBlockFactory#OnProtoPortsChanged
...
#
# @member {PropertyEvent<list[OcaProtoObjectIdentification]>} OcaBlockFactory#OnProtoMembersChanged
...
#
# @member {PropertyEvent<Dict[int, OcaProtoSignalPath]>} OcaBlockFactory#OnProtoSignalPathsChanged
...
# Global block type identifier for reusable blocks. **Added in version 2 of this
# class.**
#
