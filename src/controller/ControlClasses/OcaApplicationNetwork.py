from ....aes70.OCP1.OcaApplicationNetworkCommand import OcaApplicationNetworkCommand
from ....aes70.OCP1.OcaApplicationNetworkState import OcaApplicationNetworkState
from ....aes70.OCP1.OcaBlob import OcaBlob
from ....aes70.OCP1.OcaList import OcaList
from ....aes70.OCP1.OcaNetworkSystemInterfaceDescriptor import OcaNetworkSystemInterfaceDescriptor
...
OcaApplicationNetwork = make_control_class(
  ...
  [
    ...
    ['SystemInterfaces', [OcaList(OcaNetworkSystemInterfaceDescriptor)], 2, 4, false, false, null
    ],
